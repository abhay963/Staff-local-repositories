...
const Navbar = ({ onHoverSidebar }) => {
  ...
  return (
<nav className="fixed top-0 left-0 w-full bg-gradient-to-r from-green-700 to-green-500 shadow-md border-b text-white dark:text-white z-50 flex items-center px-6" style={{ height: "56px" }}>
      ...
      <div className="flex items-center space-x-3 w-1/4 h-full">
          <button
            ...
            className="p-2 rounded hover:bg-green-600 transition flex items-center justify-center text-white dark:text-white"
          ...
          >
            ...
            />
            <p className="text-xs font-light select-none leading-none text-white dark:text-white">Government of Jharkhand</p>
          </div>
      </div>
      ...
      <div className="flex justify-center flex-1 h-full items-center">
        <h1
          className="text-lg font-bold uppercase tracking-widest cursor-default select-none text-white dark:text-gray-200"
      ...
      <div className="flex items-center space-x-5 w-1/4 justify-end relative h-full">
        <div className="relative flex items-center justify-center" style={{ height: "36px", width: "36px" }}>
          <Bell className="w-6 h-6 cursor-pointer hover:scale-110 transition-transform text-white dark:text-gray-200" />
        ...
        <div className="relative flex items-center justify-center" style={{ height: "36px", width: "36px" }}>
          <User
            className="w-7 h-7 cursor-pointer hover:scale-110 transition-transform text-white dark:text-gray-200"
